...
public class ByzantineAWSet extends GenericProtocol {

    public static final String PROTO_NAME = "Byzantine Add-Wins Set CRDT";
    ...
    private final Logger logger = LogManager.getLogger(ByzantineAWSet.class);
    private short appProtoId;


        public ByzantineAWSet() {
        ...
        public void handleAddRequest(AddRequest req, short sourceProto) {
            ...
            sendRequest(bcast_req, SignedCrashFaultReliableBroadcastProtocol.PROTO_ID);
        }
